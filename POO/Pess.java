    ...
    public static void main(String[] args) throws Exception{
        ...
        class Pessoa{
            ...
            Pessoa(String nome, String aniversario, int idade, double altura) throws Exception{
                ...
                LocalDate dateNasci = LocalDate.parse(aniversario);
                if (dateNasci.isAfter(currentDate)){
                    throw new Exception("Nao eh possivel inserir uma data posterior a atual");
                }else{
