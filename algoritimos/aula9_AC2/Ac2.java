...
public class Ac2 {
    public static void main(String[] args) {
        ...
        int quantia = 0;           //armazena a quantia de notas (determina o número de iterações do segundo for)
        int numalunos = 0;         //armazena o número de alunos (determina o número de iterações do primeiro for)
